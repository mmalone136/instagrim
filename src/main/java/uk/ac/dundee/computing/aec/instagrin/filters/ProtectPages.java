 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp","/SinglePic.jsp","/UpdateDetails.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
